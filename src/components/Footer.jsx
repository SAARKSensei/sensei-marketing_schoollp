    ...
    <>
      <div className="flex-col sm:flex-row  flex-wrap sm:flex-nowrap rounded-[calc(4vw)] md:rounded-b-none grad-bg-2 gap-4 sm:gap-10 lg:gap-20 justify-center p-4 flex md:text-base text-xs font-normal text-slate-200">
        ...
        <span className="flex gap-2 items-center">
          <span className=" bg-white min-w-10 min-h-10 rounded-full p-2 "><Image 
        className="mt-[2px]"
        alt="mail"
        src={mail}
        sizes="auto"
        /></span>connect@sensei.org.in</span>
        ...
        alt="location"
        sizes="auto"
         />Pune, Maharastra</span>
      </div>
      <div className="relative w-max-full bg-[#2C3D68] rounded-bl-none rounded-[calc(4vw)] md:rounded-t-none p-6 md:p-10 min-[1300px]:p-20 ">

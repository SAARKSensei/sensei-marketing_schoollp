...
const Animatebg = ({ children }) => {
  ...
  return (
    <div ref={bgRef} className=" pt-6 md:p-10 min-[1300px]:p-20  relative">
      <span className="left-0 top-0 absolute w-full h-full z-[-10] bg-gradient-to-b from-[#2C3D68] to-[#0764A7] rounded-[calc(4vw)]" />
      <span
        style={{
